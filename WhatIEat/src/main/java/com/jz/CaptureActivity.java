...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback, 
  ...
  boolean handleOcrDecode(OcrResult ocrResult) {
    ...
    List<Ingredient> apiResponse = ApiAnalyser.Post(jsonPost); // makes HTTP POST request
      ...
      String firstIngredient = apiResponse.get(0).IngredientName; // just gets the first ingredient from the list
    ...
    listView.setAdapter(adapter);
      ...
      // Select Item from the list to show more details in the Popup window
      listView.setOnItemClickListener(
        new AdapterView.OnItemClickListener()
        {
          ...
          public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
              ...
              intent.putExtra("MY_KEY", details);
